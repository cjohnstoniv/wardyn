  ...
  "backends": [
    {
      ...
      "wire": "cli",              // "anthropic" | "openai" | "cli" | "fake"
      "transport": "claude",      // anthropic: api|bedrock · openai: api|azure|compatible · cli: claude|codex
...
wires are already implemented (`internal/composer/backends/`).
