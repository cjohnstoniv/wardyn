...
func newFakeVault(t *testing.T) *fakeVault {
	f := &fakeVault{t: t, mount: "wardyn", tokens: map[string]bool{}, expires: map[string]time.Time{}, jwts: map[string]string{}, tokenRole: map[string]string{}, kv: map[string]*kvEntry{}}
