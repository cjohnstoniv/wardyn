...
//
// capped is also the honest answer to "is this list complete?" — byte-cap
// truncation alone must never leave truncated=false on the wire, i.e. present
// a short list as the whole truth.
//
