...
var capKindsGolden = map[int]string{
	...
	2: "egress_host:narrowing,secret:narrowing,workspace:narrowing,image:widening,agent:narrowing,integration:narrowing,workspace_provider:narrowing,policy:narrowing",
}
