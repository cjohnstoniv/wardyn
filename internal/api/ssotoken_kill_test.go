...
func TestUploadSSOToken_KillsSignInRunAfterResponse(t *testing.T) {
	...
	t.Run("a refused capture leaves the run running", func(t *testing.T) {
		...
		body := `{"access_token":"a","refresh_token":"r","client_id":"c","client_secret":"s",` +
			`"start_url":"https://evil.awsapps.com/start","region":"us-west-2",` +
			`"account_id":"123456789012","role_name":"WardynBedrockRole","expires_at":"2100-01-01T00:00:00Z"}`
