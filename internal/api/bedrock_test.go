...
func TestResolveBedrockAuth_SubscriptionPreempts(t *testing.T) {
	...
	ba := s.resolveBedrockAuth(context.Background(), "claude-code", true /* subscriptionActive */, true /* modelRun */, false /* refresh */, nil, awsSSOScope{})
	if ba.ready {
...
func TestResolveBedrockAuth_NonClaudeAgent(t *testing.T) {
	s := fullyConfiguredBedrockServer()
	ba := s.resolveBedrockAuth(context.Background(), "codex-cli", false, true /* modelRun */, false /* refresh */, nil, awsSSOScope{})
	if ba.ready {
...
func TestResolveBedrockAuth_WorkspaceRefOverridesGlobal(t *testing.T) {
	...
	ba := s.resolveBedrockAuth(context.Background(), "claude-code", false, true /* modelRun */, false /* refresh */, ws, awsSSOScope{})
	if !ba.ready {
...
func TestResolveBedrockAuth_SkipsNonModelRun(t *testing.T) {
	s := fullyConfiguredBedrockServer()
	ba := s.resolveBedrockAuth(context.Background(), "claude-code", false, false /* modelRun */, false /* refresh */, nil, awsSSOScope{})
	if ba.ready || ba.env != nil || ba.egressHosts != nil {
...
func TestResolveBedrockAuth_AWSDirMountMissingFailsSafe(t *testing.T) {
	...
	ba := s.resolveBedrockAuth(context.Background(), "claude-code", false, true, false /* refresh */, nil, awsSSOScope{})
	if ba.ready || ba.awsMount {
...
func TestSetupBedrock_SSOLaneMatchesLaunchGate(t *testing.T) {
	...
	if ba := live.resolveBedrockAuth(context.Background(), "claude-code", false, true /* modelRun */, false /* refresh */, nil, awsSSOScope{}); !ba.ready {
	...
	if ba := renewable.resolveBedrockAuth(context.Background(), "claude-code", false, true /* modelRun */, false /* refresh */, nil, awsSSOScope{}); !ba.ready || !ba.ssoInject {
	...
	if ba := dead.resolveBedrockAuth(context.Background(), "claude-code", false, true /* modelRun */, false /* refresh */, nil, awsSSOScope{}); ba.ready {
...
func TestResolveBedrockAuth_BaseURLOverride(t *testing.T) {
	...
	t.Run("unset is byte-identical", func(t *testing.T) {
		...
		pa := plain.resolveBedrockAuth(context.Background(), "claude-code", false, true, false /* refresh */, nil, awsSSOScope{})
