...
//
// the finding gave GET /me the launch door's own bind DECISION so the console would
...
// same subject, which is the agreement the finding exists to hold.
//
...
// the member doors have been bounded since the finding, and the ADMIN doors over the same
// shares were not.
//
