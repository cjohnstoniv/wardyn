...
type AgentRun struct {
	...
	EndTightenedAt *time.Time `json:"end_tightened_at,omitempty"` // profile re-clamp (RL-8) shortened the end; migration 0086
	...
	// for it. Keepalives never move it. Nil (a run from before migration 0088,
