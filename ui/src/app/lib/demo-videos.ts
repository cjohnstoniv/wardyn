...
// table) plus 10 reserved ids the series already has a shape for
...
export const EPISODES: Episode[] = [
  { id: "00", title: "Meet Wardyn", audience: "everyone", path: "core", tag: null, file: "wardyn-00-meet-wardyn.mp4", steps: [] },
