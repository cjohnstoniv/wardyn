...
export const EPISODES: Episode[] = [
  { id: "00", title: "Meet Wardyn", audience: "everyone", path: "core", tag: null, file: "wardyn-00-meet-wardyn.mp4", minutes: "5:53", steps: [] },
  ...
  { id: "04", title: "Add a workspace", audience: "admin", path: "single", tag: null, file: "wardyn-04-add-a-workspace.mp4", minutes: "4:39", steps: ["workspaces"] },
  ...
  { id: "06", title: "Your first run", audience: "member", path: "any", tag: null, file: "wardyn-06-your-first-run.mp4", minutes: "3:58", steps: ["first-run"] },
  ...
  { id: "09", title: "Record a run", audience: "everyone", path: "core", tag: null, file: "wardyn-09-record-a-run.mp4", minutes: "6:06", steps: [] },
  { id: "10", title: "Approvals and egress", audience: "member", path: "any", tag: null, file: "wardyn-10-approvals-and-egress.mp4", minutes: "3:56", steps: ["approvals"] },
