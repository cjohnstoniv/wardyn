...
const rendered: Record<string, string> = {
  ...
  // The Bedrock and Claude subscription kinds (#538).
  "PROVIDER_EDITOR.HOW_PEOPLE_SIGN_IN": E.HOW_PEOPLE_SIGN_IN,
  "PROVIDER_EDITOR.PROVIDES_SSO": E.PROVIDES_SSO,
  "PROVIDER_EDITOR.IDC_GROUP": E.IDC_GROUP,
  "PROVIDER_EDITOR.REGION": E.REGION,
  "PROVIDER_EDITOR.SSO_SETUP_HINT": E.SSO_SETUP_HINT,
  "PROVIDER_EDITOR.MODEL_HINT_BEDROCK": E.MODEL_HINT_BEDROCK,
  "PROVIDER_EDITOR.CLAUDE_IMAGE_MISSING": E.CLAUDE_IMAGE_MISSING,
};
