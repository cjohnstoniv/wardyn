...
// compares all 93 keys. A swapped hyphen, a dropped ellipsis, a reworded
...
// collide (58 / 3 / 32); the completeness test below is what keeps that true.
...
describe("workspace-providers-copy — §7.2-§7.5 + §7.7 parsed out of the prompt doc", () => {
  it("finds all 93 frozen keys in the doc (§7.6 excluded)", () => {
    expect(doc.size).toBe(93);
  });
