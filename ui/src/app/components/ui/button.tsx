...
// forwardRef is load-bearing under React 18: Radix `asChild` triggers
// (DropdownMenuTrigger, PopoverTrigger, …) pass the popper ANCHOR ref through
// Slot, and a plain function component silently drops it — every menu/popover
// anchored to a <Button> rendered at floating-ui's off-screen "unpositioned"
// placeholder (translate(0,-200%)) instead of beside its trigger.
