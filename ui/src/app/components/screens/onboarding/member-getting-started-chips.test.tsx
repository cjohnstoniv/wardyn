...
// Split from member-getting-started.test.tsx (#195): that file was over the
// 800-line test gate. The Model access chip and Azure DevOps chip describes
// (nested under a re-created "MemberGettingStarted" wrapper carrying the same
// beforeEach) live here; the direct per-section describes stay in the sibling.
import { describe, it, expect, vi, beforeEach } from "vitest";
import { render, screen, waitFor, within } from "@testing-library/react";
import userEvent from "@testing-library/user-event";
import type { SetupStatus, SetupHarnessTool } from "../../../lib/types";
import { WithDoor } from "../../../../test/door-harness";
import { MODEL_PROVIDERS, baseMe, baseStatus, providerStatus } from "../../../lib/test-fixtures";
