...
// The form/rail state before a run is launched (the rail's honesty about
// governance and model access, the form's shape and validation, and
// Preflight) — split out of new-run-screen.test.tsx, which was already at
...
beforeEach(() => {
  ...
  // has not loaded — the answer every admin case below has always run on.
