...
describe("approvalSignals — held vs passive", () => {
  ...
  // minutes (isHeld's ADO_HOLD_WINDOW_MS arm), well inside the generic
  // 60-minute staleHeld ceiling above. At 5 minutes it must be a passive
  // pending — never held, and not (yet) staleHeld either — so the board card
