...
// Split from setup-screen.test.tsx (#195): that file was over the 800-line
// test gate. The "Skipped state" describe and the review/barrier/finish walks
// that follow it live here, re-opening the same "SetupScreen" describe (with
// its shared beforeEach and clearCorpNetworkGate helper) the sibling closes
// after the earlier walks; setupDismissed()/dismissSetup() stay there.
...
import { SetupScreen, setupDismissed } from "./setup-screen";
