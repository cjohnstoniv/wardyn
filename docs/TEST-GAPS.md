...
_Generated 2026-08-02 by `scripts/test-gaps.sh` from `test/reports/go/union/coverage-func.txt`
(union coverage total **67.0%**), cross-checked against the Postgres lane (`test/reports/go/pg/coverage-func.txt`)._
...
| **Untested** (no test reaches it) | 122 |
| Total 0.0% exported | 176 |
| _(of 447 exported funcs in the union)_ | |
...
- **cmd/wardyn**: Error
- **cmd/wardynd**: BuildDevcontainer, BuildFromDevcontainerFiles, Decide, FinalizeBase, Get, IsRevoked, List, ListRunningWithPolicy, Record, Record, Request, RevokeJTI, RevokeRun, StopRun
- **internal/api**: Peek, RunClaudeCompose, StartDrain
...
- **internal/store**: DeleteWorkspace, GetWorkspaceBySource, IsZero, Keep, LatestAuditEventByAction, ListWorkspaces, ListWorkspacesPage, Matches, QueryAuditEvents, QueryAuditEventsFilteredPage, QueryRecentAuditEvents, QueryRecentAuditEventsPage, Record, SetRunImage, SetSandboxRef, SetWorkspaceApprovedEgress, SetWorkspaceBuiltImage, SetWorkspaceImportState, SetWorkspaceLLMCred, SetWorkspaceScanResult, SetWorkspaceSetupCommands, UpdateWorkspace
- **internal/types**: Clone, RaisesApproval
- **internal/workspacescan**: PublicRegistryHosts, ValidSetupCommand
- **pkg/client**: ConnectManagedSubscription, CreateWorkspace, DeleteWorkspace, DisconnectManagedSubscription, GetSiteConfig, GetWorkspace, Healthz, ListWorkspaces, Me, New, Preflight, PutSiteConfig, RecentAuditEvents, RecordWorkspaceTask, ScanWorkspace, SetupStatus, SynthesizeProfile, UpdateWorkspace, VerifyWorkspace
