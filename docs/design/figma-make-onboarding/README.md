...
Snapshot of the Figma Make project `S8qvTh3h64MXw9u8DsK9JV` ("Redesign onboarding process",
published prototype: https://dig-urban-38399333.figma.site) taken 2026-07-10 at the
...
`file://figma/make/source/S8qvTh3h64MXw9u8DsK9JV/<path>`) when their re-skin passes start —
