...
| Active nav item | `--sidebar-accent` fill + `--sidebar-primary` rail | `navLinkClass` (`app-shell.tsx:342–348`) and the active rail (`app-shell.tsx:387`) | A third active treatment — use the shipped one |
