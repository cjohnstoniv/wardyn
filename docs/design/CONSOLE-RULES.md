...
| Active nav item | `--sidebar-accent` fill + `--sidebar-primary` rail | `navLinkClass` (`app-shell.tsx:286–292`) and the active rail (`app-shell.tsx:331`) | A third active treatment — use the shipped one |
