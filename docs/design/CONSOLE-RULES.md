...
| Active nav item | `--sidebar-accent` fill + `--sidebar-primary` rail | `navLinkClass` (`app-shell.tsx:357–363`) and the active rail (`app-shell.tsx:379`) | A third active treatment — use the shipped one |
