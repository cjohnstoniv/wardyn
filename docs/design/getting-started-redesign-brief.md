...
| Original Figma Make base file | fileKey `RvsXF1tfgSWnW17Yu1ENJb` (Opus structure — shadcn/ui + Tailwind v4) |
| Colorway reference Make file | fileKey `vEslyxZSU9h2NGJCPGuErb` (Gemini neutral monochrome) |
...
1. **Discover (½ day):** read this brief fully; open the current screenshot; browse the two Make
   source files (`RvsXF1tfgSWnW17Yu1ENJb` structure, `vEslyxZSU9h2NGJCPGuErb` colorway) to
