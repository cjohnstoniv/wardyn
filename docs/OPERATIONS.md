...
`0065` adds the envelope columns to `secrets` (`0001`'s table), so an install
carried forward from a released 0.7.x hits the identical ownership requirement
on the 0.7.12 upgrade.
