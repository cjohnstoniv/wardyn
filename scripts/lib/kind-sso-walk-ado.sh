...
# This profile's OWN tag (overlay.sh pins the release to it), never :quickstart.
WARDYND_IMAGE="wardyn/wardynd:${WARDYN_QUICKSTART_IMAGE_TAG:-kind-ado}"
PROXY_IMAGE="wardyn/wardyn-proxy:${WARDYN_QUICKSTART_IMAGE_TAG:-kind-ado}"
