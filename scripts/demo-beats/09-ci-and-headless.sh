...
#     already interpolated — paste it from the scrollback, not from memory.
#  5. CAPTURE-REGION DISCIPLINE. This segment is a gdigrab of a fixed rectangle
#     (WARDYN_DEMO_CAPTURE, default 1920x1080+0+0). Whatever else is in that
#     corner of the screen for the ~2 minutes this runs is in the video. Clear
#     it, and put the terminal there.
...
# The narration counts the FIELDS, not the lines: the file renders as 11 visual
...
# eligible_grants, auto_stop_after_sec). Verified 2026-08-17. If the fixture
# ever changes, re-count before the take — the count is spoken out loud.
