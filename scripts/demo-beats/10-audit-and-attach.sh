...
drive() {
  ...
  say "A governed platform has one last question."
  say "Afterwards, can you prove what happened?"
  ...
  say "Registered public keys only. No passwords, ever."
  ...
  say "Wardyn admits it read-only. One session, one driver."
