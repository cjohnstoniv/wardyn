...
//   - /api/v1/admin          — operator maintenance (the sandbox sweep); its devices
//     family is wrapped above
//   - /api/v1/devices        — the enrolled laptop's own routes (enrol, audit push,
//     heartbeat): a daemon's surface, not an operator's
